...
from products
where price > 250 and price < 500;

select * 
from products 
where price > 500 -- filtering
order by price asc; -- sorting


-- Write the select query for getting all products from 
-- Supplier named 'Applience World' with price greater than 300
